...
/* appearance */
static const char font[]            = "-*-terminus-medium-r-*-*-16-*-*-*-*-*-iso8859-2";
...
static const char selfgcolor[]      = "#f5deb3";
static const char selbgcolor[]      = "#224444";
/* fancybarcoloredclickable colors */
...
static const Layout layouts[] = {
	...
	{ "(@)",      spiral},   /* spiral fibonacci layout -- default because it's the first one*/
	{ "[\\\\]",     dwindle},  /* dwindle layout */
	{ "[T]",      tile },    /* good-ol' normal tile */
	{ "[TT]",    bstack},   /* bottom stack layout */
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,       XK_BackSpace,    spawn,          {.v = browsercmd } },
...
static Button buttons[] = {
	...
	{ ClkWinTitle,		0,		Button1,	focusonclick,	{0} }, /* fancybar */
